...
function initialize(app, callback) {
	...
	console.log("数据库连接参数 %s", JSON.stringify(opts.protocol));
	console.log("数据库连接参数 %s", JSON.stringify(opts.host));
	console.log("数据库连接参数 %s", JSON.stringify(opts.database));
	console.log("数据库连接参数 %s", JSON.stringify(opts.port));
	console.log("数据库连接参数 %s", JSON.stringify(opts.user));
	console.log("数据库连接参数 %s", JSON.stringify(opts.password));
	console.log("数据库连接参数 %s", JSON.stringify(opts.query));
	console.log('--------结束----------');
	// 初始化ORM模型
